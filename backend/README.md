...
## Project Structure
    ...
    ├── testapiautoconnect_105942  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_105942`
...
2. Clone this repo and `cd testapiautoconnect_105942`
